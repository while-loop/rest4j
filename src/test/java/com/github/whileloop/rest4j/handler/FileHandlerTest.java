...
public class FileHandlerTest {
    ...
    public void testResourceDirNonJar() throws Exception {
        ...
        HttpRequest r = new RequestRecorder(GET, "http://localhost/index.html");
        ResponseRecorder rec = new ResponseRecorder();
        fh.handle(r, rec);

        assertEquals(OK, rec.getStatus());
        String body = rec.getBody();
        assertEquals("text/html", rec.getFirstHeader("Content-Type"));
    ...
    public void testResourceWithStrip() throws Exception {
        ...
        HttpRequest r = new RequestRecorder(GET, "http://localhost/new/index.html");
        ResponseRecorder rec = new ResponseRecorder();
        fh.handle(r, rec);
    ...
    public void testNotFound() throws Exception {
        String dir = getClass().getClassLoader().getResource("www").toExternalForm();
        FileHandler fh = new FileHandler(dir);
        HttpRequest r = new RequestRecorder(GET, "http://localhost/fakedir/index.html");
        ResponseRecorder rec = new ResponseRecorder();
        fh.handle(r, rec);
    ...
    public void testCss() throws Exception {
        String dir = getClass().getClassLoader().getResource("www").toExternalForm();
        FileHandler fh = new FileHandler(dir);
        HttpRequest r = new RequestRecorder(GET, "http://localhost/stylesheets/bootstrap.min.css");
        ResponseRecorder rec = new ResponseRecorder();
        fh.handle(r, rec);
        ...
        assertEquals("text/css", rec.getFirstHeader("Content-Type"));
    }
}